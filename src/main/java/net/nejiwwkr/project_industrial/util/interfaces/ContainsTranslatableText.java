...
public interface ContainsTranslatableText {
    ...
    String EFFECT_TEXT_PREFIX = "effect.project_industrial.";
    String ENCHANTMENT_TEXT_PREFIX = "enchantment.project_industrial.";

    String getTranslatableTextKey();
}
