...
public class ProjectIndustrialInstructedFlatItem extends Item implements Instructed<ProjectIndustrialInstructedFlatItem>{
    ...
    public ProjectIndustrialInstructedFlatItem(Settings settings) {
        super(settings);
    }
    ...
    @Override
    public ProjectIndustrialInstructedFlatItem setTips(Text... tips) {
        this.instruct = true;
    ...
    @Override
    public ProjectIndustrialInstructedFlatItem setSummary(Text... sum) {
        this.instruct = true;
    ...
    @Override
    public ProjectIndustrialInstructedFlatItem setInformation(Text... info) {
        this.instruct = true;
